...
main = getChar >>= (\ch1 -> getChar >>= (\ch2 -> return ()))
     ...
     = bindIO (IO \world -> (world, "y")) (\ch1 -> bindIO (IO \world -> (world, "z")) ( \ch2 -> IO \world -> (world, ()) ) )
     IO (\ s -> case (\world -> (world, "y")) s of (new_s, a) -> unIO (       (\ch1 -> bindIO (IO \world -> (world, "z")) ( \ch2 -> IO \world -> (world, ()) ) )             a) new_s)
     IO (\ s -> case (\world -> (world, "y")) s of (new_s, a) -> unIO (       (\ch1 -> IO (\ s -> case (\world -> (world, "z")) s of (new_s, a) -> unIO (( \ch2 -> IO \world -> (world, ()) ) a) new_s) )             a) new_s)
     ...
     (\ s -> case (\world -> (world, "y")) s of (new_s, a) -> unIO (       (\ch1 -> IO (\ s -> case (\world -> (world, "z")) s of (new_s, a) -> unIO (( \ch2 -> IO \world -> (world, ()) ) a) new_s) )             a) new_s) 123
     case (\world -> (world, "y")) 123 of (new_s, a) -> unIO (       (\ch1 -> IO (\ s -> case (\world -> (world, "z")) s of (new_s, a) -> unIO (( \ch2 -> IO \world -> (world, ()) ) a) new_s) )             a) new_s
     case (123, "y") of (new_s, a) -> unIO (       (\ch1 -> IO (\ s -> case (\world -> (world, "z")) s of (new_s, a) -> unIO (( \ch2 -> IO \world -> (world, ()) ) a) new_s) )             a) new_s
     unIO (       (\ch1 -> IO (\ s -> case (\world -> (world, "z")) s of (new_s, a) -> unIO (( \ch2 -> IO \world -> (world, ()) ) a) new_s) )      "y") 123
     unIO (       IO (\ s -> case (\world -> (world, "z")) s of (new_s, a) -> unIO (( \ch2 -> IO \world -> (world, ()) ) a) new_s)  ) 123
     -- note "y" vanishes b/c we don't use it
     (\ s -> case (\world -> (world, "z")) s of (new_s, a) -> unIO (( \ch2 -> IO \world -> (world, ()) ) a) new_s)   123
     case (\world -> (world, "z")) 123 of (new_s, a) -> unIO (( \ch2 -> IO \world -> (world, ()) ) a) new_s
     case (123, "z") of (new_s, a) -> unIO (( \ch2 -> IO \world -> (world, ()) ) a) new_s
     unIO (( \ch2 -> IO \world -> (world, ()) ) "z") 123
     -- note "z" vanishes b/c we don't use it
     unIO ( IO \world -> (world, ()) ) 123
     \world -> (world, ()) 123
     (123, ())

     -- note that 123 isn't really 123. Read more below:
{-
